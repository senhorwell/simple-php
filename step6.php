...
<div class="container bb pt-md-5 pt-2 px-0 mb-2 d-flex flex-column">
    ...
    <div class="col-12 p-md-0">
        <div class="title float-left">
            <h3 class="p-md-0">Pedido confirmado</h3>
        </div>
    ...
    <div class="col-12">
        <form class="pt-5" method="post" action="step6.php">
            ...
            <div class="col-12 px-0 py-4 d-flex justify-content-center">
                <div class="col-md-5 col-12 px-0 text-center">
                    <h4>Seu pedido já está indo em sua entrega.</h4>
                </div>
            </div>
            <div class="col-12 px-0 py-4 d-flex justify-content-center">
                <div class="col-md-5 col-12 px-0 text-center">
                    <p>Obrigado por simplificar com a gente!</p>
                </div>
            </div>
        </form>
    </div>
